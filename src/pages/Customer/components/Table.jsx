...
const Table = ({ data }) => {
  ...
  const currentItems = sortData(filterdata).slice(
    indexOfFirstItem,
    indexOfLastItem
  );
  ...
  const deletePerson = async (id) => {
    ClientService.deletePersonal(id);
    // try {
  ...
  return (
    <>
      <div>
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              <h5 onClick={() => onEditCustomer(item)}>
        ...
        {editvisible && (
          <CustomerEdit onClose={() => setEditvisible(false)} data={editData} />
        )}
        {regaliVisble && (
          <Regali onClose={() => setRegaliVisble(false)} data={regali} />
        )}
        {userInfoVisble && (
