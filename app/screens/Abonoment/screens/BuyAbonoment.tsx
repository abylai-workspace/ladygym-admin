      ...
      <>
        <View
          ...
          style={[
            ...
            {borderColor: selectedValue === item ? COLORS.LADY_GYB_BACKGROUND : 'transparent'},
          ]}>
          <View style={styles.flexContainer}>
            <View>
              ...
              <View style={styles.flexContainer}>
                ...
                {item.arrivalAmount > 1 && (
                  <Text style={styles.time}>{item.arrivalAmount} посещений</Text>
                )}
              </View>
            </View>
            <TouchableOpacity
              ...
              <View
                style={[
                  ...
                  {borderColor: selectedValue === item.enumName ? '#CF5490' : 'transparent'},
                ]}>
        ...
        <ScrollView nestedScrollEnabled={true} style={{width: '100%'}}>
          <View style={{marginHorizontal: 15}}>
            ...
            <Text style={styles.subtitle}>
              При выборе студенческого абонемента необходимо предоставить справку с места учебы,
              либо любой подтверждающий документ
            </Text>
          ...
          <View style={styles.hr} />
          <Text style={styles.headerTitle2}>У вас есть промокод?</Text>
