    ...
    <>
      <SafeAreaView>
        ...
        <SwipeableDialog isActive={visibleFitnes} onSwipeClose={onSwipe}>
          ...
          <Counter
            onPressIMT={() => setVisibleImgBottomSheet(true)}
            onPressKBJ={() => setVisibleKBjusheet(true)}
          />
          <TrainCards
            onPress={() => setVisibleTrainnformation(true)}
        ...
        <Trainnformation
          ...
          toggleModal={onPressTrainnformation}
          goBack={goBackGym}
          trainerInfo={trainerInfo}
        />
        <ImgBottomSheet
          isModalVisible={visibleIMGBottomSheet}
          toggleModal={govisibleIMGBottomSheet}
          goBack={govisibleIMGBottomSheet}
        />
        <Kbjusheet
          isModalVisible={visiblekbjusheet}
          toggleModal={goVisibleKBJUSheet}
          goBack={goVisibleKBJUSheet}
        />
      </SafeAreaView>
    </>
  );
