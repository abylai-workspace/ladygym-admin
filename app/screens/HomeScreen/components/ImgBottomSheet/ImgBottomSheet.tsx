  ...
  return (
    <ModalBottom isModalVisible={isModalVisible} toggleModal={toggleModal}>
      ...
      <View style={styles.container}>
        ...
        <Input placeholder={'Введите рост в см'}  onChangeText={text => setHeight(text)} value={height}/>
        <Text style={styles.headerSubTitle}>Вес</Text>
        <Input placeholder={'Введите вес в кг'}  onChangeText={text => setWeight(text)} value={weight}/>
        ...
        <View style={{flexDirection: 'row', justifyContent: 'space-between', marginTop: 10}}>
          <View>
            ...
            <Input placeholder={'0 кг'} style={{paddingHorizontal: 40}} value={currentIMT} onChangeText={text => setCurrentIMT(text)}/>
          </View>
          <View>
            <Text style={styles.headerSubTitle}>Текущий ИМТ</Text>
            <Input placeholder={'0 кг'} style={{paddingHorizontal: 40}} value={idealWeight} onChangeText={text => setIdealWeight(text)}/>
          </View>
        </View>
